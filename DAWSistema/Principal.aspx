            ...
            <div class="cards-container">
                ...
                <div class="card" id="cardFlota" runat="server">
                    ...
                    <div class="card-content">
                        ...
                        <asp:Button ID="btnABMFlota" runat="server" Text="Ir a Flota (ABM)" CssClass="btn-card outline" OnClick="btnABMFlota_Click" />
                    </div>
                </div>
                ...
                <div class="card" id="cardBitacora" runat="server">
                    ...
                    <div class="card-content">
                        ...
                        <asp:Button ID="btnBitacora" runat="server" Text="Ir a Bitácora" CssClass="btn-card outline" OnClick="btnBitacora_Click" />
                    </div>
                </div>
                ...
                <div class="card" id="cardSeguridad" runat="server">
                    ...
                    <div class="card-content">
                        ...
                        <asp:Button ID="btnSeguridad" runat="server" Text="Panel de Seguridad" CssClass="btn-card outline" OnClick="btnSeguridad_Click" />
                    </div>
                </div>
