...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', Tahoma, sans-serif; background-color: #f4f7f6; color: #333; margin: 0; padding: 40px; }
        .container { background-color: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); max-width: 1000px; margin: auto; }
        h2 { color: #8B0000; margin-bottom: 20px; border-bottom: 2px solid #eee; padding-bottom: 10px; }
        .grid-view { width: 100%; border-collapse: collapse; margin-bottom: 30px; }
        .grid-view th { background-color: #f8f9fa; padding: 12px; text-align: left; }
        ...
        .form-control { padding: 10px; border: 1px solid #ccc; border-radius: 6px; }
        ...
        .btn-volver { background-color: transparent; border: 1px solid #8B0000; color: #8B0000; float: right; }
    </style>
</head>
<body>
