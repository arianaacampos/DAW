...
<head>
    ...
    <style>
        /* Agregué esto que faltaba para que no se rompan las medidas */
        * {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="box" style="border-left: 5px solid #28a745; border-left-color: #333333;">
                ...
                <asp:TextBox ID="txtRutaBackup" runat="server" CssClass="form-control" Text="C:\Backups\" style="margin-bottom: 15px; font-weight: bold;"></asp:TextBox>

                <asp:Button ID="btnBackup" runat="server" Text=" Generar Backup" CssClass="btn-green" OnClick="btnBackup_Click" />
            </div>

            <div class="box" style="border-left: 5px solid #dc3545; border-left-color: #333333;">
                ...
                <asp:Button ID="btnRestore" runat="server" Text="Ejecutar Restore" CssClass="btn-red" OnClick="btnRestore_Click" OnClientClick="return confirm('ATENCIÓN: Esta acción sobreescribirá la base de datos actual perdiendo todos los cambios nuevos. ¿Deseas continuar?');" />
            </div>
