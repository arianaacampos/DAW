    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Panel ID="panelMaster" runat="server" Visible="false">
                ...
                <div class="btn-group">
                    <asp:Button ID="btnRecalcular" runat="server" Text="⚙️ Recalcular DV" CssClass="btn btn-recalcular" OnClick="btnRecalcular_Click" OnClientClick="return confirm('ALERTA: ¿Estás seguro de RECALCULAR todos los Dígitos Verificadores? Esto actualizará la firma de seguridad oficial de toda la base de datos.');" />
